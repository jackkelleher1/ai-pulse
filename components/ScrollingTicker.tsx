...
const SOURCE_DOT: Record<string, string> = {
  ...
  anthropic:         "bg-rose-400",
  openai:            "bg-teal-400",
  deepmind:          "bg-blue-400",
  microsoft_ai:      "bg-sky-300",
  theverge:          "bg-red-400",
  techcrunch:        "bg-green-400",
  wired:             "bg-gray-400",
  ars_technica:      "bg-orange-300",
  the_decoder:       "bg-violet-400",
  nytimes:           "bg-gray-300",
  huggingface:       "bg-amber-400",
  mit_tech_review:   "bg-red-300",
  venturebeat:       "bg-violet-300",
  tldr_ai:           "bg-indigo-400",
  wsj:               "bg-blue-300",
  marketwatch:       "bg-green-300",
};
